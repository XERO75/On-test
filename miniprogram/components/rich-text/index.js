    ...
    navigateTo: function navigateTo(id, offset) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        selector.exec(function (res) {
          ...
          var scrollTop = res[1].scrollTop + res[0].top - (res[2] ? res[2].top : 0) + (offset || parseInt(_this.data.useAnchor) || 0);
          if (_this._in) {
            // scroll-view 跳转
            _this._in.page.setData(_defineProperty({}, _this._in.scrollTop, scrollTop));
          } else {
            // 页面跳转
            wx.pageScrollTo({
              scrollTop: scrollTop,
      ...
      if (this.data.lazyLoad || this.imgList._unloadimgs < this.imgList.length / 2) {
        ...
        var callback = function callback(rect) {
          ...
          if (rect.height === height) {
            _this3.triggerEvent('ready', rect);
          } else {
            height = rect.height;
            setTimeout(function () {
